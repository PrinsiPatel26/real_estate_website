...
export function PremiumServicesLayout() {
  return (
    <>
      <section aria-labelledby="services-introduction-heading" className="bg-[#f2efe8] py-16 text-[#151515] sm:py-24 lg:py-28">
        <div className="mx-auto grid max-w-shell gap-10 px-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-24 lg:px-10">
          <div>
      ...
      <section aria-labelledby="featured-services-heading" className="overflow-hidden bg-[#0b0b0b] py-16 text-white sm:py-24 lg:py-28">
        <div className="mx-auto max-w-shell px-5 lg:px-10">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {featured.map(([title, text, Icon], index) => (
              <Reveal key={title} className="group flex min-h-[340px] flex-col border border-white/12 bg-[#151515] p-7 transition duration-300 hover:-translate-y-1 hover:border-[#c9a227]/70 hover:shadow-[0_18px_40px_rgba(0,0,0,0.3)] sm:p-9">
                <div className="flex items-start justify-between">
                  <span className="flex h-12 w-12 items-center justify-center border border-[#c9a227]/45 text-[#d4af37]"><Icon className="h-5 w-5" strokeWidth={1.5} aria-hidden="true" /></span>
                  <span className="font-display text-2xl font-medium text-[#d4af37]">{String(index + 1).padStart(2, '0')}</span>
                </div>
                <h3 className="mt-9 max-w-[15rem] font-display text-[1.65rem] font-medium uppercase leading-[1.1] !text-white">{title}</h3>
      ...
      <section aria-labelledby="service-categories-heading" className="bg-[#f7f5f0] py-16 text-[#151515] sm:py-24 lg:py-28">
        <div className="mx-auto max-w-shell px-5 lg:px-10">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {categories.map(([title, text, Icon], index) => (
              <Reveal key={title} className="group min-h-[220px] border border-[#b48c32]/25 bg-[#f2efe8] p-7 transition duration-300 hover:-translate-y-1 hover:border-[#c9a227]/70 sm:p-8">
                <div className="flex items-start justify-between"><span className="flex h-10 w-10 items-center justify-center border border-[#c9a227]/40 text-[#c9a227]"><Icon className="h-4 w-4" strokeWidth={1.5} aria-hidden="true" /></span><span className="font-display text-xl font-medium text-[#c9a227]">{String(index + 4).padStart(2, '0')}</span></div>
