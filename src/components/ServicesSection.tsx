  ...
  return (
    <section id="services" className="bg-white py-20 text-[#111111] sm:py-28 lg:py-32">
      <div className="mx-auto max-w-[1300px] px-5 sm:px-8 lg:px-10">
        <div className="flex flex-col justify-between gap-6 border-b border-[#e8e6e0] pb-10 lg:flex-row lg:items-end">
        ...
        <div className="mt-10 grid gap-px border border-[#e8e6e0] bg-[#e8e6e0] sm:grid-cols-2 lg:grid-cols-3">
          {services.map(([title, text, Icon], index) => (
            <Reveal as="article" key={title} delay={index * 0.04} className="group bg-white p-7 transition-colors duration-200 hover:bg-[#f8f8f6] sm:p-8">
              ...
              <h3 className="mt-8 text-sm font-medium tracking-[0.12em] text-[#111111] uppercase">{title}</h3>
