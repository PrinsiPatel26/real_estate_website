  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-[#e8e6e0] bg-white pb-12 pt-28 text-[#111111] sm:pb-16 sm:pt-32 lg:pt-36">
      ...
      <>
          ...
          <div aria-hidden="true" className="absolute inset-0 -z-10 bg-white/85" />
        </> :
      null}
      ...
      <div className="mx-auto w-[90%] max-w-shell">
        ...
        <nav aria-label="Breadcrumb">
            <ol className="flex flex-wrap items-center gap-1.5 text-[0.62rem] uppercase tracking-[0.2em] text-[#666666]">
            ...
            <li key={crumb.label} className="flex items-center gap-1.5">
              ...
              <ChevronRightIcon className="h-3 w-3 text-[#111111]/40" aria-hidden="true" /> :
              null}
                </li>
            )}
            </ol>
        ...
        <Reveal delay={0.08}>
          <h1 className="mt-6 max-w-3xl font-display text-[2.3rem] font-light leading-[1.02] tracking-[-0.03em] text-[#111111] sm:text-[3.2rem] lg:text-[4rem]">
            {title}
          </h1>
        </Reveal>
        {intro ?
        <Reveal delay={0.12}>
            <p className="mt-6 max-w-2xl text-[0.95rem] leading-relaxed text-[#666666]">{intro}</p>
          </Reveal> :
        null}
      </div>
    </section>);
