...
export function Services() {
  ...
  return <>
    <section className="relative flex min-h-[72svh] items-end overflow-hidden bg-[#0b0b0b] pb-16 pt-32 text-white sm:pb-20 lg:min-h-[78svh] lg:pb-24">
      <div className="absolute inset-0 opacity-35" style={{ backgroundImage: `url(${projects[0].card})`, backgroundPosition: 'center', backgroundSize: 'cover' }} aria-hidden="true" />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.88),rgba(0,0,0,0.58)_58%,rgba(0,0,0,0.72))]" aria-hidden="true" />
      <div className="relative mx-auto w-full max-w-shell px-5 lg:px-10">
    ...
    <section className="relative flex min-h-[300px] items-center justify-center overflow-hidden bg-[#0b0b0b] py-20 text-center text-white sm:min-h-[360px]">
      <div className="absolute inset-0 opacity-35" style={{ backgroundImage: `url(${projects[1].card})`, backgroundPosition: 'center', backgroundSize: 'cover' }} aria-hidden="true" />
      <div className="absolute inset-0 bg-[#0b0b0b]/75" aria-hidden="true" />
      <div className="relative px-5"><p className="eyebrow text-[#d4af37]">The next address</p><h2 className="mt-5 max-w-2xl font-display text-[2.2rem] font-medium leading-tight !text-white sm:text-[3.3rem]">The right property decision starts with the right guidance.</h2></div>
    </section>
    <ContactSection />
  </>;
}
